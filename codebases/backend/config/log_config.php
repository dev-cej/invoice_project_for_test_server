...
ini_set('error_log', '/var/www/html/invoiceProject/logs/php-error.log');
...
function logPythonError($file, $error, $severity = 'ERROR') {
    $logFile = '/var/www/html/invoiceProject/logs/python_errors.log';
...
function logGeneralError($message, $severity = 'ERROR') {
    $logFile = '/var/www/html/invoiceProject/logs/general_errors.log';
    $timestamp = date('Y-m-d H:i:s');
...
function logPythonScriptError($errorOutput) {
    $logFile = '/var/www/html/invoiceProject/logs/python_script_errors.log';
    $timestamp = date('Y-m-d H:i:s');
